...
const activitySchema = new mongoose.Schema({
    ...
    scheduleDays: [{ type: mongoose.Schema.Types.ObjectId, ref: 'schedule_days', required: true }],
    scheduleHours: [{ type: mongoose.Schema.Types.ObjectId, ref: 'schedule_hours', required: true }],
